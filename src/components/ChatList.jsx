    ...
    <section className='relative hidden lg:flex flex-col items-start justify-start bg-white h-[100vh] w-[100%] md:w-[600px]'> 
      ...
      <div className='w-[100%] mt-[10px] px-5'>
        <header className='flex items-center justify-between'>
          <h3 className='text-[16px] '>Message ({0})</h3>
          <SearchModal/>
        </header>
      </div>
      <main className='flex flex-col items-start mt-[1.5rem] pb-3'>
        <button className=' flex justify-between items-start w-[170%] border-b border-b-1 border-[#a4b8b8] px-5 pb-2 pt-2'>
          <div className='flex items-start '>
            <img src={avatar} alt="" className='w-[40px] h-[40px] object-cover rounded-full' />
            <span>
              <h2 className='p-0 font-semibold text-[#a3a3a3] text-left text-[17px]'>Destiny Franks</h2>
              <p className='p-0 font-light text-[#a3a3a3] text-left text-[17px]'>hey there how are you..</p>
            </span>
          </div>

          <p className='text-[15px] font-light text-[#a3a3a3]'>6th februvary,2025</p>
        </button>
